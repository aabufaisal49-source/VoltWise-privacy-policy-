...
export const CleanPolicyPageView: React.FC<CleanPolicyPageViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans antialiased">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-10 sm:py-16">
        {/* Bilingual Status Notice */}
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl bg-slate-100/90 border border-slate-200 text-xs text-slate-700 print:hidden min-w-0">
          <div className="flex items-start sm:items-center gap-2 min-w-0">
            <Globe className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5 sm:mt-0" />
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 break-words">
        ...
        <div className="mb-10 grid grid-cols-1 sm:grid-cols-3 gap-4 bg-white border border-slate-200 rounded-2xl p-5 shadow-xs print:hidden">
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-100 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className="text-xs font-bold text-slate-900 truncate">تخزين محلي آمن (Room DB)</h4>
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-100 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className="text-xs font-bold text-slate-900 truncate">أذونات محددة بدقة</h4>
              <p className="text-[11px] text-slate-600 mt-1 break-words">
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-100 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className="text-xs font-bold text-slate-900 truncate">متوافق مع متاجر التطبيقات العالمية</h4>
              <p className="text-[11px] text-slate-600 mt-1 break-words">
                جاهز تماماً لمتطلبات أمان البيانات وإرشادات الخصوصية الصارمة.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* The Paper Document */}
        <article className="bg-white border border-slate-200/80 rounded-2xl p-8 sm:p-14 shadow-sm min-w-0">
          <div
            className="prose prose-slate max-w-none break-words overflow-wrap-anywhere
              ...
              prose-li:my-1.5
              prose-a:text-emerald-600 prose-a:underline hover:prose-a:text-emerald-700 prose-a:font-semibold break-all sm:break-words
